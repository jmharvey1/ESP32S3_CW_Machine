...
CWSNDENGN::CWSNDENGN(esp_timer_handle_t *Timr_Hndl, LVGLMsgBox *MsgBx_ptr)
{
	DotClk = Timr_Hndl;
	pMsgBx = MsgBx_ptr;
	////ptft = tft_ptr;
...
int CWSNDENGN::Intr(void){
	/*this executes as part of an ISR interrupt; NO printf statement Allowed*/
