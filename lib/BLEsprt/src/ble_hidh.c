                                               ...
                                               void *event_data)
{
    ...
    case ESP_HIDH_OPEN_EVENT:
        sprintf(evntname, "ESP_HIDH_OPEN_EVENT(%d)\n", (int)event_id);
        break;
    case ESP_HIDH_BATTERY_EVENT:
        sprintf(evntname, "ESP_HIDH_BATTERY_EVENT(%d)\n", (int)event_id);
        break;
    case ESP_HIDH_INPUT_EVENT:
        sprintf(evntname, "ESP_HIDH_INPUT_EVENT(%d)\n", (int)event_id);
        break;
    case ESP_HIDH_FEATURE_EVENT:
        sprintf(evntname, "ESP_HIDH_FEATURE_EVENT(%d)\n", (int)event_id);
        break;
    case ESP_HIDH_CLOSE_EVENT:
        sprintf(evntname, "ESP_HIDH_CLOSE_EVENT(%d)\n", (int)event_id);
        break;
    case ESP_HIDH_START_EVENT:
        sprintf(evntname, "ESP_HIDH_START_EVENT(%d)\n", (int)event_id);
        break;
    case ESP_HIDH_STOP_EVENT:
        sprintf(evntname, "ESP_HIDH_STOP_EVENT(%d)\n", (int)event_id);
        break;
    case ESP_HIDH_MAX_EVENT:
        sprintf(evntname, "ESP_HIDH_MAX_EVENT(%d)\n", (int)event_id);
        break;
    default:
        sprintf(evntname, "ESP_HIDH_UNKNOWN_EVENT(%d)\n", (int)event_id);
        break;
    }
    ...
    */
    ...
    if(CB_intrvl < 500){
        ...
        while(CB_intrvl < MaxWaitTime)
        {
            ...
            {
              old_intrvl = CB_intrvl;  
            }
            else
            { 
              MaxWaitTime =  CB_intrvl; 
            }
