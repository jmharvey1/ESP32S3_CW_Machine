...
/*JMH ADD to trace specific issues*/
void _lv_Post(lv_log_level_t level, const char * file, int line,
                 const char * func, const char * format, ...) LV_FORMAT_ATTRIBUTE(5, 6);
/*JMH use the following to trace specific issues*/
//replace ' do {}while(0)' with the following
//_lv_Post(LV_LOG_LEVEL_TRACE, __FILE__, __LINE__, __func__, __VA_ARGS__)                 
/**********************
 *      MACROS
 **********************/
#ifndef LV_LOG_TRACE
