...
#ifndef _BT_KEYBOARD_H_
#define _BT_KEYBOARD_H_
...
// const char *ble_addr_type_str(esp_ble_addr_type_t ble_addr_type);
    ...
    /*new*/
    esp_err_t init_low_level(uint8_t mode);
  ...
  public:
    BTKeyboard(LVGLMsgBox *msgbx_ptr, DF_t *Dft_ptr) : bt_scan_results(nullptr),
